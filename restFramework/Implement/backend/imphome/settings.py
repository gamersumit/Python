"""
Django settings for imphome project.
...
SECRET_KEY = 'django-insecure-@umtd_9guzmt-s4h(ookfo$zny7mrm!o!$k21@4mf2dxjkkilh'
...
WSGI_APPLICATION = 'imphome.wsgi.application'
